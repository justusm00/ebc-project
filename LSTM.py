...
def train_LSTM(features, hidden_size, num_layers, window_size):
    ...
    trainloader, valloader, testloader = TimeSeries_SplitLoader(series_data=series_data, series_targets=series_targets, window_size=window_size)
...
if __name__ == '__main__':
    train_LSTM(features=FEATURES, hidden_size=hidden_size, num_layers=num_layers, window_size=window_size)